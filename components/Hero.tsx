    ...
    >
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto">
        <motion.h1
          ...
          className="text-5xl xs:text-6xl sm:text-7xl md:text-8xl lg:text-9xl font-bold mb-4 sm:mb-6 tracking-tight px-2"
        >
          PRASANJEET
        </motion.h1>
        ...
        >
          <a
            ...
            className="relative px-6 sm:px-8 py-3 sm:py-4 bg-[#25D366] text-white rounded-full font-medium text-base sm:text-lg overflow-hidden group transition-all duration-300 hover:bg-[#20BA5A] flex items-center gap-2 w-full sm:w-auto justify-center"
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-[#20BA5A] to-[#25D366] opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
          </a>
          <button
            ref={buttonRef}
            onClick={() => {
            ...
            className="relative px-6 sm:px-8 py-3 sm:py-4 bg-white/10 border border-white/20 text-white rounded-full font-medium text-base sm:text-lg overflow-hidden group transition-all duration-300 hover:bg-white/20 w-full sm:w-auto"
          >
